...
<head>
	<title> Branch Management | RMU </title>
...
<body>
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-lg-8">
							<div class="card">
								<div class="card-header align-items-center d-flex">
									<h4 class="card-title mb-0 flex-grow-1"> List of Branches </h4>
	...
	<script>
		...
		$('#save-branches').click(function(){
			let id = $(this).data('id')
			let url = (id === 0 ? `${baseUrl}/createBranch` : `${baseUrl}/updateBranch/`+id)
		...
		function deactivate(id, status){
			...
			$.ajax({
				url: `${baseUrl}/deactivateBranch/`+id+`/`+stats, 
				type: 'GET', 
				headers:{
					'Authorization':`Bearer ${ auth.token }`,
				},
